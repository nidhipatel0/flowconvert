...
export function FileUploader() {
  ...
  return (
    ...
    >
      ...
      <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-teal-900/30 mb-6 border border-teal-500/20">
        <svg
          className="h-10 w-10 text-teal-300 transition-all duration-300 hover:scale-110 hover:text-teal-200"
          stroke="currentColor"
          fill="none"
          viewBox="0 0 48 48"
          aria-hidden="true"
      ...
      <div className="mb-4">
        ...
        <p className="mt-2 text-base text-teal-200">
          {isDragging ? 'Release to upload' : 'or click to browse from your computer'}
        </p>
      </div>
      ...
      {/* Privacy Badge (inline version) */}
      <div className="inline-flex items-center gap-2 rounded-full px-4 py-2 bg-teal-900/30 border border-teal-500/30">
        <svg
